    ...
    <form action="{{ route('obat.update', $obat->id) }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select name="bentuk" class="form-control">
                    <option value="" {{ old('bentuk', $obat->bentuk) }}>Pilih</option>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select name="kategori" class="form-control">
                    <option value="" {{ old('kategori', $obat->kategori) }}>Pilih</option>
            ...
            <div class="form-group">
                ...
                <select name="status_aktif" class="form-control">
                    ...
                    <option value="0" {{ !$obat->status_aktif ? 'selected' : ''}}>Non-Aktif</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" min="0" name="stok_gudang" class="form-control"
                    value="{{ old('stok_gudang', $obat->stok_gudang ?? 0) }}">
            </div>
            <div class="form-group">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label>Status Aktif</label>
                <select name="status_aktif" class="form-control">
                    <option value="1" {{ old('status_aktif', $obat->status_aktif) ? 'selected' : '' }}>Aktif</option>
                    <option value="0" {{ !old('status_aktif', $obat->status_aktif) ? 'selected' : '' }}>Non-Aktif</option>
                </select>
            </div>
        </div>
